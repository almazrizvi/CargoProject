...
* The original package name 'com.freight,management.discovery-service' is invalid and this project uses 'com.freight.management.discovery_service' instead.
...
* [Spring Boot Actuator](https://docs.spring.io/spring-boot/3.5.11-SNAPSHOT/reference/actuator/index.html)
